...
Public Class report_grafik
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "restaurant.report_grafik.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedreport_grafik
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As report_grafik = New report_grafik()
        rpt.Site = Me.Site
        Return rpt
    End Function
